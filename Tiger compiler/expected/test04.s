...
L1_nfactor:
	# FRAME L1_nfactor(2 formals, 14 locals)
	pushl %ebp
	movl %esp, %ebp
	subl $64, %esp
	# SP, FP, calleesaves, argregs have values
...
L3_if_else:                                       # x86gen:122
	...
	movl %ebx, -36(%ebp)                      # x86gen:316 x86frame:594
	movl -28(%ebp), %eax                      # x86gen:317 x86frame:582
	movl -36(%ebp), %ebx                      # x86gen:322 x86frame:418
	imull %ebx                                # x86gen:322 x86frame:423
	movl %eax, -36(%ebp)                      # x86gen:323 x86frame:575
	movl -36(%ebp), %ebx                      # x86gen:117 x86frame:589
	movl %ebx, -40(%ebp)                      # x86gen:117 x86frame:594
L4_if_join:                                       # x86gen:122
	movl -40(%ebp), %eax                      # x86gen:117 x86frame:582
...
L2_if_then:                                       # x86gen:122
	...
	movl -44(%ebp), %ebx                      # x86gen:117 x86frame:589
	movl %ebx, -40(%ebp)                      # x86gen:117 x86frame:594
