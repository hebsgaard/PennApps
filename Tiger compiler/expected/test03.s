...
L3_fvar_nnil:                                     # x86gen:122
	...
	movl %ebx, -56(%ebp)                      # x86gen:265 x86frame:594
	...
	movl %ebx, -52(%ebp)                      # x86gen:316 x86frame:594
	...
	movl -52(%ebp), %ebx                      # x86gen:322 x86frame:418
	imull %ebx                                # x86gen:322 x86frame:423
	movl %eax, -52(%ebp)                      # x86gen:323 x86frame:575
	movl -56(%ebp), %ebx                      # x86gen:270 x86frame:522
	movl -52(%ebp), %ecx                      # x86gen:270 x86frame:528
	addl %ecx, %ebx                           # x86gen:270 x86frame:533
	movl %ebx, -56(%ebp)                      # x86gen:270 x86frame:539
	movl -60(%ebp), %ebx                      # x86gen:431 x86frame:320
	movl $L4_string, %ebx                     # x86gen:431 x86frame:325
	movl %ebx, -60(%ebp)                      # x86gen:431 x86frame:330
	movl -56(%ebp), %ebx                      # x86gen:114 x86frame:302
	movl -60(%ebp), %ecx                      # x86gen:114 x86frame:307
	movl %ecx, (%ebx)                         # x86gen:114 x86frame:312
	movl -4(%ebp), %ebx                       # x86gen:218 x86frame:340
	movl %ebx, -64(%ebp)                      # x86gen:218 x86frame:345
	movl -64(%ebp), %eax                      # x86gen:117 x86frame:582
