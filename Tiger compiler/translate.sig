...
sig
  ...
  type level (* describe a static nesting level *)
  type access (* describe a level and a frame access located there *)
  type exp (* represents an IR expression *)
  type frag (* a fragment of generated IR code *)
